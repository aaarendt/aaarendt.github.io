...
<div className="grid-wrapper">
    <div className="col-6">
        ...
        <p>Jeff and Anthony are hosting two hour long virtual retreats on Saturdays, 10:00 AM to 12:00 PM Pacific Time, on the following date: April 17.</p>
    ...
    <ul className="actions uniform">
        <li><a href="https://www.eventbrite.com/e/male-journeys-supporting-our-spirits-in-these-challenging-times-tickets-134914624273" className="button special">Register</a></li>
    </ul>
</center>
